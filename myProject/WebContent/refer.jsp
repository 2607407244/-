...
<%@ page import="team.model.ArticleInfo"%>
		...
		<div class="row">
			<div class="col-md-3 function aside-style">
				...
				<a class="link" href="refer.jsp">推荐博文</a> <a class="link"
					href="food.jsp">美食天地</a>
				<a class="link" href="internet.jsp">网络技术</a> <a class="link"
					href="focus.jsp">关注博文</a> <a class="link" href="editor.jsp">编写博客</a>
				<a class="link" href="self-Text.jsp">个人博文</a> <a class="link" href="#">个人信息</a>
				<a class="link" href="login.jsp">退&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;出</a>
			</div>
